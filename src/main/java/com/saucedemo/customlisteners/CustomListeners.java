...
import static com.saucedemo.utilities.Utilities.takeScreenShot;
...
public class CustomListeners implements ITestListener {
    ...
    public void onStart(ITestContext iTestContext) {
        reporter = new ExtentSparkReporter(System.getProperty("user.dir")+"/test-output/extent.html");//file location for report you have generated
